...
public class SeleniumXpathLocatorsTest {
    ...
    public void idLocatorTest() {
        WebElement headerSearchTextBox = driver.findElement(By.xpath("//*[@id='header-search']"));
    ...
    public void classNameLocatorTest() {
        WebElement headerSearchTextBox = driver.findElement(By.xpath("//*[@class='nQ8aBP7fBN']"));
    ...
    public void nameLocatorTest() {
        WebElement headerSearchTextBox = driver.findElement(By.xpath("//input[@name='text']"));
...
//        spans.get(173).click();
    ...
    public void otherAttributesLocatorTest() {
        List<WebElement> divs = driver.findElements(By.xpath("//div[@data-zone-name='category-link']"));
    ...
    public void parentLocatorTest() {
        WebElement headerSearchTextBox = driver.findElement(By.xpath("//*[@id='header-search']"));
        headerSearchTextBox.sendKeys("Холодильник");
//        driver.findElement(By.xpath("//*[text()='Найти']")).click(); // будет org.openqa.selenium.ElementClickInterceptedException
...
//        WebElement link = driver.findElement(By.xpath("//*[@class='_381y5orjSo _21NjfY1k45']"));
        WebElement link = driver.findElement(By.xpath("//*[contains(@class, '_21NjfY1k45')]"));
    ...
    public void cascadeSearchTest() {
        ...
        SleepUtils.sleep(3000);
        WebElement menu = driver.findElement(By.xpath("//div[contains(@class, '_21NjfY1k45')]"));
        SleepUtils.sleep(1500);
        List<WebElement> menuItems = menu.findElements(By.xpath("*[@data-zone-name='category-link']"));

        SleepUtils.sleep(1500);
        for (WebElement menuItem : menuItems) {
            try {
                WebElement span = menuItem.findElement(By.xpath(".//span"));
    ...
    public void searchTest() {
        ...
        SleepUtils.sleep(3000);
        SleepUtils.sleep(1500);
        List<WebElement> menuItems = driver.findElements(By.xpath("//*[@data-zone-name='category-link']//span"));
